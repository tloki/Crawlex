...
# zamisilio sam pageRank kao void funkciju koja nista ne vraca vec samo mijenja pagerank vrijednosti svakog cvora,
# elementa liste
# isto tako bilo bi dobro (mozda) da imamo posebno listu sa svim stranicama i posebno graf s tim elementima liste
# (uvjeren sam da je laksa iteracija i da je sve poslozenije i lakse je trazit stvari) -> tako sam i koncipirao sam
# pagerank
...
# prl lista je dosta sklepan nacin da matplotlib nacrta cvorove cija velicina prati page rank (jer treba proslijediti
# array)
